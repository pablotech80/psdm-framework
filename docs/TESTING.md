...
- Run `npm test` for CLI regression coverage around audit, init dry-run, classify, PR checklist, validate, custom config, validation profiles, unsupported profile validation, and feature artifact behavior.
