...
- `src/lib/shell.mjs` builds target-specific project context, reuses the audit and staged-inspection engines, and renders the dependency-free read-only terminal UI.
