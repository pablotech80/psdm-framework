...
`0.17.0-alpha`: AI guardrail templates.

Goal:

Add project-owned AI governance artifacts without adding native runtime observability or LangSmith-style measurement.

Planned outcomes:

- Add guardrail templates for AI behavior, data classification, cost/latency budgets, prompt-injection tests, and eval expectations.
- Keep templates focused on policy, evidence, owner review, and stop conditions.
- Avoid adding native tracing, hosted evals, dashboards, or runtime telemetry collection.
- Preserve compatibility with external evidence generated by project-owned scripts or specialized observability tools.
